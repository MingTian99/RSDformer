...
# RSDformer calculate PSNR on RGB channel, Thus Test is set to False

parser = argparse.ArgumentParser(description='PSNR SSIM LPIPS', add_help=False)
parser.add_argument('--generated_images_path', default='Results/thick_haze', help='Generated / Restored / Recovered images -path')
parser.add_argument('--target_path', default='data/Sate_1K/Haze1K_thick/test/target', help='Ground-truth -path')
parser.add_argument('--Test_Y', default=False, help='True: test Y channel only; False: test RGB channels')
parser.add_argument('--init_model', default='alex', help='Initializing the model,alex or vgg')
parser.add_argument('-v', '--version', type=str, default='0.1')
parser.add_argument('--crop_border', type=int, default='64', help='same with scale')
