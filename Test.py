...
parser.add_argument('--data_path', type=str, default='data/Sate_1K/Haze1K_thick/test/input', help='input images path')
parser.add_argument('--save_path', type=str, default='Results/thick_haze', help=' Save the Restored images path')
parser.add_argument('--eval_workers', type=int, default=1)
parser.add_argument('--weights', type=str, default='pretrained_models/thick_haze.pth', help='pre-trained model')
...
def splitimage(imgtensor, crop_size=opt.crop_size, overlap_size=opt.overlap_size):
...
def mergeimage(split_data, starts, crop_size=opt.crop_size, resolution=(1, 3, opt.crop_size, opt.crop_size)):
